...
//        var Adapter1: InnerAdapter ?= null
    }
...
//                    val song: TypesofActivities?= data.getValue(TypesofActivities::class.java)
//                    (holder.List).add(song!!)
//                }
...
//                Toast.makeText(Activities1,"Error occured", Toast.LENGTH_SHORT).show()
//            }
//
//        })
    }
